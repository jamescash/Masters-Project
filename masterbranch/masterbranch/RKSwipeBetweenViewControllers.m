...
CGFloat SELECTOR_Y_BUFFER = 30.0; //%%% the y-value of the bar that shows what page you are on (0 is the top)
...
- (void)addNavBarForPeopleAttendingGig
{
       ...
       //pageController.navigationController.navigationBar.topItem.titleView = navigationView;
        ...
        pageController.navigationController.navigationItem.leftBarButtonItem = customBarItem;
